---
title: '消息队列面试题'
description: '消息队列面试题整理，覆盖 MQ 通用问题、RabbitMQ、Kafka、消息可靠性、顺序消息和延迟队列。'
outline: [2, 3]
---

# 消息队列面试题

本页整理 MQ 通用问题、RabbitMQ 和 Kafka 高频面试题。RabbitMQ 内容完整保留为传统消息中间件考点，Kafka 部分会说明 ZooKeeper 和 KRaft 的版本差异。
